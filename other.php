<?php
    ...
    for ($i=1; $i<21; $i++) {
        ...
        $sql = mysqli_query($connect,"SELECT * FROM other WHERE id='$id'");
...
<html lang="en">
  ...
  <body style="background-color:#000000;">
        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="navbar-brand" href="other.php"><font face="微軟正黑體">其他</font></a>
                    </li>
                </ul>
            </div>
    ...
    <div class="container">
        ...
        <h2 class="mt-4 mb-3"><font face="微軟正黑體" color="#ffffff">兔兔其他區</font></h2>
        ...
        <div class="row">
            ...
            <?php
                ...
                //有   就讀取資料庫
                //沒有 就隨機生成20筆
                $sql = mysqli_query($connect,"SELECT * FROM other WHERE type='其他'");
                ...
                if($num < 1){
                    ...
                    print '</div>';
                    $imgurl = $img;
                    $sql = "INSERT INTO `other`(`id`,`type`,`page`,`imgurl`,`price`) VALUES ($i,'其他',1,'$imgurl',$price);";
                    mysqli_query($connect,$sql);
                    }
                }else{
                    ...
                    for ($i=1; $i<21; $i++){
                        ...
                        print '<div class="card text-center">';
                        print '<a href="#" data-toggle="modal" data-target="#exampleModalScrollable'.$i.'">';
                        $sql = mysqli_query($connect,"SELECT * FROM other WHERE id='$i'");
                        $row= mysqli_fetch_array($sql);
                        $img = $row["imgurl"];
    ...
    <?php
        ...
        print '<form action="other.php" method="post">';
        for ($i=1; $i<21; $i++){
