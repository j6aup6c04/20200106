<?php
    ...
    for ($i=1; $i<21; $i++) {
        ...
        $sql = mysqli_query($connect,"SELECT * FROM main WHERE id='$id'");
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <?php
                ...
                //有   就讀取資料庫
                //沒有 就隨機生成20筆
                $sql = mysqli_query($connect,"SELECT * FROM main WHERE type='首頁'");
                ...
                if($num < 1){
                    ...
                    print '</div>';
                    $imgurl = $img;
                    $sql = "INSERT INTO `main`(`id`,`type`,`page`,`imgurl`,`price`) VALUES ($i,'首頁',1,'$imgurl',$price);";
                    mysqli_query($connect,$sql);
                    }
                }else{
                    ...
                    for ($i=1; $i<21; $i++){
                        ...
                        print '<div class="card text-center">';
                        print '<a href="#" data-toggle="modal" data-target="#exampleModalScrollable'.$i.'">';
                        $sql = mysqli_query($connect,"SELECT * FROM main WHERE id='$i'");
                        $row= mysqli_fetch_array($sql);
                        $img = $row["imgurl"];
