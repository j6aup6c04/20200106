<?php
    ...
    if(mysqli_query($connect,"create database if not exists `product`;")) {
        ...
        //PRIMARY KEY = 主鍵
        $sql =  "CREATE TABLE IF NOT EXISTS wristband (
    ...
    for ($i=1; $i<21; $i++) {
        ...
        $sql = mysqli_query($connect,"SELECT * FROM wristband WHERE id='$id'");
...
<html lang="en">
  ...
  <body style="background-color:#000000;">
    ...
    <form action="" method="post">
        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="navbar-brand" href="wristband.php"><font face="微軟正黑體">手環</font></a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        ...
        <h2 class="mt-4 mb-3"><font face="微軟正黑體" color="#ffffff">兔兔手環區</font></h2>
        ...
        <div class="row">
            ...
            <?php
                ...
                //有   就讀取資料庫
                //沒有 就隨機生成20筆
                $sql = mysqli_query($connect,"SELECT * FROM wristband WHERE type='手環'");
                ...
                if($num < 1){
                    ...
                    $img = "http://placeimg.com/250/25". $i%10 ."/animals";
                    ...
                    print '</div>';
                    $imgurl = $img;
                    $sql = "INSERT INTO `wristband`(`id`,`type`,`page`,`imgurl`,`price`) VALUES ($i,'手環',1,'$imgurl',$price);";
                    mysqli_query($connect,$sql);
                    }
                }else{
                    ...
                    for ($i=1; $i<21; $i++){
                        ...
                        print '<div class="card text-center">';
                        print '<a href="#" data-toggle="modal" data-target="#exampleModalScrollable'.$i.'">';
                        $sql = mysqli_query($connect,"SELECT * FROM wristband WHERE id='$i'");
                        $row= mysqli_fetch_array($sql);
                        $img = $row["imgurl"];
    ...
    <?php
        ...
        print '<form action="wristband.php" method="post">';
        for ($i=1; $i<21; $i++){
